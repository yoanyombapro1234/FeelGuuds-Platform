...
export default [
  ...
  },
  {
    ...
    images: [images.b01, images.b02, images.b03]
  },
  {
    ...
    message: (
      <React.Fragment>
        ...
        <br />
        - will make people stay beyond checkout if they use them, then want to
        change, shower etc :(
        <br />
        - if they get in trouble, you know who they will call...
        <br />
        - adds more work, need to brief guests on what to do, where to go, life
        jackets in different sizes blah blah 😅
        <br />
      </React.Fragment>
    )
  },
