  ...
  <ContainerHorizontal className={cls["socialio-home"]}>
    <ScrollArea className={cls["socialio-feed"]}>
      ...
      <PostWrapper>
        <PostHeader />
        <p>
          Just bought these photos from @rion_photography! So happy with the
          results. They are your best option for nature photos. #nature
      ...
      <PostWrapper>
        <PostHeader />
        <p>
          Which store sells the best soaps and is part of the #eco-friendly
          community? #ineed #lookingforhelp #small-business
        </p>
        <Divider />
        <PostActions />
        <Divider />
