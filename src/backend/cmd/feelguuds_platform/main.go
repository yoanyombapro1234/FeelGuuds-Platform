...
import (
	...
	"github.com/yoanyombapro1234/FeelGuuds-Platform/src/backend/internal/authentication_handler"
	"github.com/yoanyombapro1234/FeelGuuds-Platform/src/backend/internal/helper"
	"github.com/yoanyombapro1234/FeelGuuds-Platform/src/backend/internal/merchant"
	"github.com/yoanyombapro1234/FeelGuuds-Platform/src/backend/pkg/api"
	"github.com/yoanyombapro1234/FeelGuuds-Platform/src/backend/pkg/grpc"
	"github.com/yoanyombapro1234/FeelGuuds-Platform/src/backend/pkg/signals"
...
func configureEnvironmentVariables(fs *pflag.FlagSet) {
	...
	fs.String("CERT_PATH", "/go/src/github.com/yoanyombapro1234/FeelGuuds-Platform/src/backend/certificate/cert",
...
func LoadEnvVariables(fs *pflag.FlagSet) {
	viper.AddConfigPath("/Users/yoanyomba/go/src/github.com/yoanyombapro1234/FeelGuuds-Platform/src/backend")
	viper.BindPFlags(fs)
